...
public class GenerateInvitationKeyHandler(IInvitationLinkService generateInvitationService, IValidator<GenerateInvitationKeyRequest> validator) : IRequestHandler<GenerateInvitationKeyRequest, GenerateInvitationKeyResponse>
{
    ...
    public async Task<GenerateInvitationKeyResponse> Handle(GenerateInvitationKeyRequest request, CancellationToken cancellationToken = default)
    {
        ...
        if (!validationResult.IsValid)
        {
            ...
            return new GenerateInvitationKeyResponse
            {
                IsSuccess = false,
