...
{
    Task<Result<AddedGroup?>> AddGroup(IEnumerable<long> memberIds, long ownerId, string name, string? description, string currencyKey, CancellationToken cancellationToken = default);
